...
void rules()
{
	...
	cout<<"Rules: The game consists of 13 rounds. Each player rolls five dice and"<<endl;
	cout<<" attempts to score different combinations. Each turn consists of 3 rolls."<<endl;
	cout<<"A round is complete when each player has taken their turn. For each "<<endl;
	cout<<"roll, the player may choose to keep any number of dice he or she wishes."<<endl;
	cout<<"The object of the game is to fill every possible scoring combination, "<<endl;
	cout<<"and the player with the highest total score wins! For each round, each"<<endl;
	cout<<"player must enter a score into one of the combinations. The player may "<<endl;
	cout<<" enter a 0 into any box if he or she does not wish to enter a score for "<<endl;
	cout<<"the current dice combination left at the end of the turn."<<endl;
