...
def getQuestion():
    input("Enter your question for the wisdom of the magic 8-Ball:\n")


def answerSelection(answered):
    answers = ["Yes.", "No.", "Without a doubt.", "Yes, definitely.", "Outlook good.", "Don't count on it.",
               "My sources say no.", "Very doubtful.", "Ask again later.", "Concentrate and ask again."]
    size = 9
